        ...
        <section className="success" id="about">
          <div className="container">
            ...
            <div className="row">
                ...
                <div className="row" style={{'margin':'20px 0px'}}>
                    <div id="beas-toronto-address" className="col-md-4">
                        <h3>TORONTO</h3>
                    ...
                    <div id="beas-montreal-address" className="col-md-4">
                        <h3>MONTREAL</h3>
                    ...
                    <div id="beas-brampton-address" className="col-md-4">
                        <h3>BRAMPTON</h3>
                ...
                <div className="row" style={{'margin':'20px 0px'}}>
                  <div id="beas-mississauga-address" className="col-md-4">
                      <h3>MISSISSAUGA</h3>
                      <p>Weekly Satsang Centre by Public <br/>
                      Every Sunday from 10.00 AM to 11 AM<br/>
                      Lincoln Alexander Secondary School <br/>
                      3545 Morning Star Drive, Mississauga, ON L4T 1Y3<br/>
                      Canada</p>
                  </div>
                  <div id="beas-kitchener-address" className="col-md-4">
                      <h3>KITCHENER</h3>
                      <p>Weekly Satsang Centre by Public <br/>
                  ...
                  <div id="beas-vancouver-address" className="col-md-4">
                      <h3>VANCOUVER</h3>
