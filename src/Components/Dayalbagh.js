            ...
            <div className="container">
                ...
                <div className="row" style={{'margin':'20px 0px'}}>
                    <div className="col-lg-12">
                      ...
                      <p>More  information: <a id="dayalbagh-wiki" href="https://en.wikipedia.org/wiki/Dayalbagh" rel="noopener noreferrer" target="_blank">Dayalbagh (Agra)</a><br/>
                      Official Website: <a id="dayalbagh-official-website" href="http://www.dayalbagh.org.in" rel="noopener noreferrer" target="_blank"> Dayalbagh</a>
                     </p>
                      </div>
                </div>
                <div className="row">
                ...
                <div className="row" style={{'margin':'20px 0px'}}>
                    <div id="dayalbagh-cambridge-address" className="col-md-8">
                        <u><h3>Cambridge</h3></u>
                        <p>Opening soon</p>
                        <p>96 Queen St E.<br/>
              ...
              <div style={{'margin':'75px 0px'}}>
                ...
                <div id="dayalbagh-facebook-widget" className="row text-center" style={{'margin':'50px 10px 10px 10px'}}>
